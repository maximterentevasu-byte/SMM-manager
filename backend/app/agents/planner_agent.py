...
is_sensitive = false (Категория 1 — обезличенный контент):
- Образовательный / полезный контент по теме ниши (топ-5, лайфхаки, гиды)
- Лайфстайл и вдохновение без привязки к конкретному товару
- Общие советы, тренды, интересные факты о нише
- Брендовые ценности и философия без конкретики
→ AI СГЕНЕРИРУЕТ ТЕКСТ САМОСТОЯТЕЛЬНО

is_sensitive = true (Категория 2 — чувствительная информация):
- Пост требует конкретного товара из ассортимента (название, фото)
- Пост о конкретном сотруднике (имя, история, фото)
- Рецепт или обзор с конкретным продуктом из продажи
- Акция/скидка с конкретными условиями
- Ивент или мероприятие с деталями
- Анонс новинки с названием и описанием
- Пост требует фото магазина, товара или команды
→ НУЖНО СПРОСИТЬ У ВЛАДЕЛЬЦА
