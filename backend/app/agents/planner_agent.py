...
ПРАВИЛА для info_questions:
- Директивная форма — глагол в начале: "Напиши...", "Укажи...", "Пришли фото...", "Перечисли..."
- НЕ дублируй: если два запроса касаются одного (товар + его характеристика) — объедини в ОДИН запрос
- Для фото/видео: начинай с "Пришли фото ..." или "Загрузи видео ..."
- Максимум 3 запроса, только то, что реально нужно для именно этого поста
- НЕ заканчивай на "?"
