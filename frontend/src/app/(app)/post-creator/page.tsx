...
function BrandContextPanel({
  ...
  return (
    <div style={{ marginBottom: 12, padding: "12px 14px", background: "#FFF8F0", border: "1px solid #FED7AA", borderRadius: 12 }}>
      ...
      <div style={{ fontSize: 11, color: "#92400E", marginBottom: 8 }}>Выберите файл — ИИ учтёт его визуальный стиль при генерации</div>
        ...
        {assets.map((a, i) => {
          ...
          return (
            <button key={i} onClick={() => onToggleRef(i, a)}
              style={{
                padding: "5px 12px", borderRadius: 20, cursor: hasData ? "pointer" : "default",
